...
<div class="container-fluid">
    ...
    <a href="{{ route('layanan-kami.create') }}" class="btn btn-primary mb-3">Tambah Layanan Kami</a>
                    ...
                    <tbody>
                        ...
                        @foreach ($ourServices as $service)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{ route('layanan-kami.edit',$service->id) }}"><i class="fa fa-edit"></i></a>
                                    
                                    <form action="{{ route('layanan-kami.destroy',$service->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('delete')
